...
public class FirstServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//response.sendRedircet("secondRedirect");
		
//		같은 context명을 사용하기에 생략 가능.
//		서블릿명 또는 jsp 파일명 다음에 ? 이후 즉 query string이라고 하며
//		서블리셍 전달할 값을 명시.
//		그때 name = value로 여러개이면 name=value&name1=value1로 작성.
//		response.sendRedirect("/servletExample/secondRedirect?name=Younghee");
		response.sendRedirect("secondRedirect?name=Younghee&id=yh1234&email=yh1234@gmail.com");
	}
